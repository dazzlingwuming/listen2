  ...
  Sound.prototype = {
    ...
    create: function () {
      ...
      if (parent._webAudio) {
        ...
        // Listen 1 Desktop analyses the real streaming element instead of
        // drawing a synthetic spectrum. HTTP media must opt into CORS before
        // src is assigned; local files keep their native file:// behaviour.
        if (
          typeof process !== 'undefined' &&
          process.versions &&
          process.versions.electron &&
          /^https?:/i.test(parent._src)
        ) {
          self._node.crossOrigin = 'anonymous';
        } else {
          self._node.removeAttribute('crossorigin');
        }
